...
class Account:
   ...
   def login(self):
      ...
      while attempts < max_attempts:
           ...
           if self.username == username_login and self.password == password_login:
   ...
   def start(self):
      try:
       ...
       self.login()
         ...
         self.create_account()
         account_file.write(f"{self.username}\n{self.password}") 
         account_file.close()
